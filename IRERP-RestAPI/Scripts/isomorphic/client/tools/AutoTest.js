...
// <P>
// These extensions and a brief user guide can be found in the 
// <var class="smartgwt"><code>selenium/</code> directory in the top level of the SDK.</var> 
// <var class="smartclient"><code>smartclientSDK/tools/selenium/</code> directory of the SDK.</var> 
// <P>
// For load testing with Selenium, take a look at
// +externalLink{http://browsermob.com,BrowserMob}.
// <P>
// <b>SOASTA</b>
// <P>
...
if (isc.DynamicForm) {
    ...
    isc.FormItem.addProperties({
        ...
        // Implement getElementFromSplitLocator at the FormItem level. This means if a developer
        ...
        getInnerElementFromSplitLocator : function (locatorArray) {
            ...
            // If we weren't passed any details, default to the focus element if there is one
            // otherwise the text box element
            } else {
            ...
            // Date Buttons. Only releveant if we're showing the date in question!
                        ...
                        (this.month == month || this.month == month+1 || this.month == month-1))
                {
                    ...
                    if (this.showWeekends || !Date.getWeekendDays().contains(buttonDay)) {
                        ...
                        var start = Date.createLogicalDate(this.year, this.month, 1);
                        ...
                        if (Date.compareDates(buttonDate, start) != 1) {
                            ...
                            var end = Date.createLogicalDate(this.year, this.month+1, 1);
        ...
        showingDate : function (date) {
            for (var i = 0; i < this.fields.length; i++) {
                ...
                this.logWarn("date passed in:" + date.toShortDate() +
                    "compared with:" + Date.createLogicalDate(field._yearNum, field._monthNum, field._dateNum).toShortDate());
            } 
