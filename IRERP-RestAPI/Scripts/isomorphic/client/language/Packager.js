...
isc.version = "8.2/LGPL Development Only";
isc.versionNumber = "8.2";
isc.buildDate = "2011-12-05";
isc.expirationDate = "${expiration}";

// license template data
isc.licenseType = "LGPL";
isc.licenseCompany = "";
isc.licenseSerialNumber = "fe78e094ce41acc69addff1dfe0a2435";
...
isc._optionalModules = {
    ...
    PluginBridges: {present: "${includePluginBridges}", name: "PluginBridges Module"},
    RichTextEditor: {present: "${includeRichTextEditor}", name: "RichTextEditor Module"},
    ...
    transactions: {present: "${includeTransactions}", name: "Automatic Transaction Management", serverOnly: true, isFeature: true}    
};
