...
isc.DateUtil.addClassMethods({
    ...
    getStartOf : function (date, period, logicalDate) {
        ...
        switch (period) {
            ...
            case "W":
                // start of week
                if (logicalDate) {
                    return Date.createLogicalDate(year, month, (dateVal-dayOfWeek));
                } else {
                    return Date.createDatetime(year, month, (dateVal-dayOfWeek), 0, 0, 0, 0);
                }
    ...
    getEndOf : function (date, period, logicalDate) {
        ...
        switch (period) {
            ...
            case "W":
                // end of week
                var endDate = dateVal + (6-dayOfWeek);
                if (logicalDate) {
