...
getEmptyMessageHTML : function (startCol,endCol,offline) {
    ...
    if (this.isPrinting) { 
        ...
        return "<TABLE role='presentation' cellspacing=0 style='width:100%' class='" + this.emptyMessageTableStyle +
                "'>" +
    ...
    sb.append(
			"<TABLE role='presentation' BORDER=0 MARGIN=0 CELLSPACING=0 CLASS='",this.emptyMessageTableStyle,
...
//              "embeddedComponents");    
    if (position == this._$within) {
        ...
        var expandedComponentDelta = 0,
            components = record._embeddedComponents;
        for (var i = 0; i< components.length; i++) {
            var expComponent = record._embeddedComponents[i];
...
setSelection : function (selection) { 
    ...
    if (this.selection.isA("CellSelection")) {
        ...
        this.observe(this.selection, "setSelected", "observer._setSelectedObservation(observed);");
    }
},
