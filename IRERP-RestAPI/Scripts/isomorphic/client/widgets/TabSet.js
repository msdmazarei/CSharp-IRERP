...
initWidget : function () {
    ...
    if (this.useSimpleTabs) {
        ...
        if (!verticalTabs) this.tabProperties.autoFit = true;
        if (verticalTabs) this.tabProperties.autoFitDirection = isc.Canvas.VERTICAL;
        else this.tabProperties.autoFitDirection = isc.Canvas.HORIZONTAL;
