...
isc._commonMenuButtonProperties = {
    ...
    _addRollOverOverrides : function (menu, menuButton) {
        ...
        menu.mouseOver = function () {
            ...
            if (!root.showMenuOnRollOver) return this.Super("mouseOver", arguments);

            root.checkRollOverMouseOver(root, this);
        };

        menu.mouseOut = function () {
            var root = this.rootMenuButton;
            if (!root.showMenuOnRollOver) return this.Super("mouseOut", arguments);

            root.checkRollOverMouseOut(root, this);
        };
    ...
    mouseOver : function() {
        if (!this.showMenuOnRollOver) return this.Super("mouseOver", arguments);
        this.checkRollOverMouseOver(this, this);
    },

    mouseOut : function() {
        if (!this.showMenuOnRollOver) return this.Super("mouseOut", arguments);
        this.checkRollOverMouseOut(this, this);
    }
