...
isc.SearchForm.addProperties({
    // Undocumented property to check for editability of fields. SearchForms respect field.canFilter
    // rather than field.canEdit
...
isc.SearchForm.addMethods({
    ...
    getEditorType : function (field) {
        ...
        if (type == "date" && field.editorType == null) return "DateRangeItem";
