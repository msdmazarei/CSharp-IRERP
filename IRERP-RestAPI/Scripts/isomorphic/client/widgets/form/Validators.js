...
// invalid, an exception is thrown and the error message is displayed in the client.  For
// additional troubleshooting information, set the log category org.apache.Velocity to DEBUG in
...
// complete DataSource record.  For most types of cross-field validation, you should use:
// <pre>
//     $dataSource.findById($record.<i>primaryKeyField</i>).otherFieldName
// </pre>
// .. as a means of looking up the stored value for a field that may not have been submitted in
// the same change.  Note that, while a DSRequest provides dsRequest.oldValues, these values
// cannot be relied upon for a security check since they could be faked.
// <P>
...
isc.Validator.addClassProperties({
    ...
    _validatorDefinitions : {
        ...
        isFloat: {
            type:"isFloat",
            title:"Value is a floating point number",
            valueType:"none",
            dataType:"none",            
            condition : function (item, validator, value) {
                if (value == null || isc.is.emptyString(value)) return true;
        ...
        isTime: {
            type:"isTime",
            title:"Value is a logical Time value",
            valueType:"none",
            dataType:"none",            
            condition : function (item, validator, value) {
                if (value == null || isc.is.emptyString(value) || isc.isA.Date(value)) return true;
        ...
        integerRange: {
            type:"integerRange",
            title:"Value is an integer within the specified range",
        ...
        lengthRange: {
            type:"lengthRange",
            title:"Value is a string whose length falls within the specified range",
        ...
        contains:{
            type:"contains",
            title:"Value contains the specified substring",
            valueType:"fieldType",
            dataType:"text",
        ...
        doesntContain: {
            type:"doesntContain",
            title:"Value does not contain the specified substring",
            valueType:"fieldType",
            dataType:"text",
            valueAttribute:"substring",
            condition : function (item, validator, value) {
        ...
        substringCount: {
            type:"substringCount",
            title:"Value contains a specified substring multiple times",
            valueType:"custom",
            dataType:"text",
        ...
        regexp: {
            type:"regexp",
            title:"Value matches a regular expression",
            valueType:"fieldType",
            dataType:"text",
        ...
        mask: {
            type:"mask",
            title:"Value matches a regular expression mask",
            valueType:"custom",
            dataType:"text",
        ...
        dateRange:{
            type:"dateRange",
            title:"Value is a date within the specified range",
            valueType:"valueRange",
            dataType:"date",
            rangeStartAttribute:"min",
            rangeEndAttribute:"max",
        ...
        floatRange: {
            type:"floatRange",
            title:"Value is a floating point number within the specified range",
        ...
        floatPrecision: {
            type:"floatPrecision",
            title:"Value is a floating point number specified to the appropriate precision",
            // Editor implemented in RuleEditor.js - simple dynamicForm based canvasItem
            // with fields for each attribute.
            valueType:"custom",
            dataType:"float",
        ...
        readOnly: {
            ...
            action : function (result, item, validator, record, component) {
                ...
                if (validator.readOnlyComponent != null) {
                    var component = window[validator.readOnlyComponent];
                    if (component == null) {
                        this.logWarn("ReadOnly validator has specified component:"
                            + validator.readOnlyComponent + " - unable to find a component with this " +
                            " ID. Ignoring.");
                        return;
                    }
                    if (validator.fieldAppearance == isc.Validator.HIDDEN) {
                        if (result == true) component.setVisibility("hidden");
                        else component.setVisibility("inherit");
                    } else {
                        if (validator.fieldAppearance != isc.Validator.DISABLED) {
                            this.logWarn("ReadOnly type rule has field appearance set to:" 
                                + validator.fieldAppearance + " and has a specified readOnlyComponent" 
                                + ". This is not supported - using appearance disabled instead.");                        
                        }
                        if (result == true) component.setDisabled(true);
                        else component.setDisabled(false);
                    }
                    
                    // Ignore any specified item.
                    return;
                }
        ...
        message : {
            type:"message",
            title:"displays an informational or warning message",
        ...
        populate : {
            type:"populate",
            title:"Populates a target field with a value calculated based on values in other fields",
...
isc.Validator.addClassMethods({
    ...
    performAction : function (result, item, validator, record, component) {
        ...
        if (actionFunction == null && validator.action) {
            ...
            if (!isc.isA.Function(validator.action)) {
                ...
                isc.Func.replaceWithMethod(validator, "action",
                                           "result,item,validator,record,component");
            }
            actionFunction = validator.action;
        }
        // call the action method
        if (actionFunction != null) {
            actionFunction(result, item, validator, record, component);
        }
    },
