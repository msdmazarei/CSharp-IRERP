...
_handleNativeKeyDown : function (DOMevent, fromOnHelp) {
    ...
    if (returnVal != false && 
        ((isc.Browser.isIE && EH._syntheticKeypressFired[lastEvent.keyName] != true && 
...
handleKeyPress : function (nativeEvent, scEventProperties) {
    ...
    if ((isc.Browser.isIE || isc.Browser.isMoz)
        && lastEvent.keyName == isc.EH._$f10 && isc.EH.shiftKeyDown()) {
...
_handleContextMenu : function (DOMEvent) {
    ...
    var fromMouseEvent = isc.Browser.isSafari || (this.isMouseEvent(this.lastEvent.eventType));
