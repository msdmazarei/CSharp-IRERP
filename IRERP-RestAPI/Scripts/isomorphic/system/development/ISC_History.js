...
if(isc.SA_Page.isLoaded()){this.$ad(_2)}else{isc.SA_Page.onLoad(function(){this.$ad(_2)},this)}},$ad:function(_1){if(this.$ae==_1){if(this.$af)return}
this.$af=true;if(!this.$s){this.logWarn("ready to fire history callback, but no callback registered."+"Please call isc.History.registerCallback() before pageLoad."+" If you can't register your callback before pageLoad, you"+" can call isc.History.getCurrentHistoryId() to get the ID"+" when you're ready.");return}
