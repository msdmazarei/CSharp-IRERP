...
_2.add(_6)}}
if(this.waitOnAnimation)this.$81e=true;if(_1.requiresModules&&!isc.FileLoader.moduleIsLoaded(_1.requiresModules))
...
return _1}
,isc.A.animationComplete=function isc_ExampleViewer_animationComplete(){this.$81e=false;this.loadExampleFilesCallback()}
...
if(this.$81e||this.remainingCSSFiles||this.loadingModules){return}
...
,isc.A.formatFolderList=function isc_FeatureExplorer_formatFolderList(_1){var _2=this.exampleTree;var _3=_2.data;var _4=_3.getChildren(_1);if(!_4||_4.length==0)return isc.emptyString;var _5=isc.StringBuffer.create();_5.append("<table class='explorerFolderList' align='center' cellSpacing='5'>");var _6=[];var _7=Math.round(_4.length/ 2);var _8=0;var _9=_7;for(var i=0;i<_7;i++){var _11=_4[_8++];var _12=_4[_9++];this.$81g(_11,_5);_5.append("<td width=10>&nbsp;</td>");this.$81g(_12,_5);_5.append("</tr>")}
_5.append("</table>");return _5.toString()}
,isc.A.$81g=function isc_FeatureExplorer__htmlForCell(_1,_2){var _3=this.exampleTree;var _4=_3.data;if(!_1){_2.append("<td>&nbsp;</td>");return}
...
,isc.A.setGrid=function isc_GridSearch_setGrid(_1){this.grid=_1;this.defaultSearchProperty();if(isc.isA.TreeGrid(_1)){if(_1.$780)_1.getNodeTitle=_1.$780;_1.$780=_1.getNodeTitle;_1.getNodeTitle=function(_5,_6,_7){var _2=_1.$780(_5,_6,_7);if(_5.$781){var _3,_4;if(_2.match(/<.*>/)){_4=new RegExp("(^|>)([^<]*?)("+_5.$781+")","ig");_3=_2.replace(_4,"$1$2<span style='background-color:#00B2FA;'>$3</span>")}else{_4=new RegExp("("+_5.$781+")","ig");_3=_2.replace(_4,"<span style='background-color:#00B2FA;'>$1</span>")}
_2=_3}
return _2}}else{if(_1.$782)_1.formatCellValue=_1.$782;_1.formatCellValue=function(_2,_5,_6,_7){if(_1.$782){_2=_1.$782(_2,_5,_6,_7)}
if(_2!=null&&_5.$781){var _3,_4;if(_2.match(/<.*>/)){_4=new RegExp("(^|>)([^<]*?)("+_5.$781+")","ig");_3=_2.replace(_4,"$1$2<span style='background-color:#FF0000;'>$3</span>")}else{_4=new RegExp("("+_5.$781+")","ig");_3=_2.replace(_4,"<span style='background-color:#FF0000;'>$1</span>")}
_2=_3}
return _2}}}
...
,isc.A.revertState=function isc_GridSearch_revertState(){var _1=this.grid;if(this.$783){delete this.$783.$781;_1.refreshRow(_1.getRecordIndex(this.$783))}
this.$784=this.$783=null;if(this.$785){for(var i=0;i<this.$785.length;i++)_1.data.closeFolder(this.$785[i])}
this.$785=null;this.clearValue("search")}
...
_1=_1.toLowerCase();var _2=this.$784==_1&&this.$783;this.$784=_1;var _3=this.grid;var _4=isc.isA.TreeGrid(_3)?_3.data.getAllNodes():_3.getData();var _5=this.$783?_4.indexOf(this.$783):0;if(_2)_5++;if(this.$783){delete this.$783.$781;_3.refreshRow(_3.getRecordIndex(this.$783));this.$783=null}
var _6=this.findNext(_4,_5,_1);if(!_6)_6=this.findNext(_4,0,_1);if(_6){this.$783=_6;_6.$781=_1;if(this.$785){for(var i=0;i<this.$785.length;i++)_3.data.closeFolder(this.$785[i])}
this.$785=null;if(isc.isA.TreeGrid(_3)){var _8=_3.data.getParents(_6);this.$785=[];for(var i=0;i<_8.length;i++){var _9=_8[i];if(!_3.data.isOpen(_9)){this.$785.add(_9);_3.data.openFolder(_9)}}
if(_3.data.isFolder(_6)&&!_3.data.isOpen(_6)){_3.data.openFolder(_6);this.$785.add(_6)}}
