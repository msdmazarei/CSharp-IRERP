...
/*
  ...
  Version 8.2/LGPL Development Only (2011-12-05)
...
);isc.B._maxIndex=isc.C+13;isc.Time.$iv();isc.Time.setDefaultDisplayTimezone(new Date().getTimezoneOffset(),true);isc.defineClass("PubSub");isc.A=isc.PubSub;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$70h={};isc.A.$70i=0;isc.B.push(isc.A.getSubscribers=function isc_c_PubSub_getSubscribers(_1){return(this.$70h[_1]=this.$70h[_1]||[])}
,isc.A.subscribe=function isc_c_PubSub_subscribe(_1,_2,_3){var _4=this.getSubscribers(_1),_5=this.$70i++;_4.add({subscriptionId:_5,target:_2,callback:_3});return _5}
...
);isc.B._maxIndex=isc.C+11;isc.ClassFactory.defineClass("HiddenFrame");isc.A=isc.HiddenFrame;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A._stats={draws:0,destroys:0};isc.A.$66k=[];isc.B.push(isc.A.$70j=function isc_c_HiddenFrame__killLoadingIndicators(){if(isc.Browser.isMoz)this.delayCall("$70k")}
,isc.A.$70k=function isc_c_HiddenFrame__doKillLoadingIndicators(){var _1=isc.HiddenFrame.create();_1.draw();_1.destroy()}
);isc.B._maxIndex=isc.C+2;isc.A=isc.HiddenFrame.getPrototype();isc.A.text="&nbsp;";isc.A._generated=true;isc.A.$70l=[];isc.A.pollInterval=100;isc.A=isc.HiddenFrame.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.init=function isc_HiddenFrame_init(){isc.ClassFactory.addGlobalID(this);isc.HiddenFrame.$66k.add(this)}
...
if(!this.$70m()){if(!this.$70n){this.$70o=isc.Page.setEvent("load",this.getID()+".draw()",isc.Page.FIRE_ONCE);this.$70n=true}
if(_1!=null){this.$70l[this.$70l.length]=_1}}else{this.$70p();for(var i=0;i<this.$70l.length;i++){this.fireCallback(this.$70l[i])}
if(_1!=null)this.fireCallback(_1)}
return this}
,isc.A.$70p=function isc_HiddenFrame__draw(){var _1=this.getDocument().body;var _2="<IFRAME ID="+this.getName()+" NAME="+this.getName()+" SRC=\""+(this.location?this.location:isc.Page.getBlankFrameURL())+"\" STYLE='position:absolute;visibility:hidden;top:-1000px'"+"></IFRAME>";isc.Element.createAbsoluteElement(_2);if(!(isc.Browser.isIE&&isc.Browser.minorVersion<5.5)){this.$70q=isc.Element.get(this.getName());if(!isc.Browser.isSafari)this.$70r=this.$70q.contentWindow}
if(this.$70r==null){for(var i=0;i<window.frames.length;i++){var _4=window.frames[i];if(_4.name==this.getName()){this.$70r=_4;break}}}
this.$t1=true;return this.$70r}
,isc.A.isDrawn=function isc_HiddenFrame_isDrawn(){return this.$t1}
,isc.A.$70m=function isc_HiddenFrame__safeToDraw(){return isc.Page.isLoaded()||!isc.Browser.isMoz}
,isc.A.destroy=function isc_HiddenFrame_destroy(){if(isc.isA.Canvas(this.$70s)){this.$70s.destroy();delete this.$70s;isc.HiddenFrame._stats.destroys++}
if(window[this.ID])window[this.ID]=null;isc.HiddenFrame.$66k.remove(this);if(this.$70n){isc.Page.clearEvent("load",this.$70o)}
...
if(this.$70q!=null){isc.Element.clear(this.$70q);this.$70q=null}
if(this.$70r!=null)this.$70r=null;this.logDebug("Destroyed "+this.ID)}
,isc.A.getHandle=function isc_HiddenFrame_getHandle(){return this.$70r}
,isc.A.getName=function isc_HiddenFrame_getName(){return this.getID()}
,isc.A.getFrameDocument=function isc_HiddenFrame_getFrameDocument(){var _1=(isc.Browser.isSafari&&isc.Browser.safariVersion<523.129?this.$70q:this.$70r);try{return _1.document}catch(e){return null}}
...
,isc.A.sendForm=function isc_HiddenFrame_sendForm(_1,_2,_3){if(_1!=null)this.formHTML=_1;if(_2!=null)this.formName=_2;if(_3!=null)this.fieldList=_3;if(!this.$70m()){this.logDebug("delaying comm until page load");isc.Page.setEvent("load",this.getID()+".sendForm()",isc.Page.FIRE_ONCE);return}
...
if(isc.isA.Canvas(this.$70s))this.$70s.destroy();this.$70s=isc.Canvas.create({autoDraw:true,ID:this.getID()+"$70s",visibility:"hidden",top:-9999,width:1,height:1,contents:this.formHTML,_generated:true,$wb:true});isc.HiddenFrame._stats.draws++;var _1=isc.Element.get(this.formName);for(var _2 in this.fieldList){if(this.fieldList[_2]!=null)_1.elements[_2].value=this.fieldList[_2]}
...
,isc.A.$t6=function isc_Canvas__getInnerHTML(_1){if(isc.$dd)arguments.$de=this;this.$70t();var _2=this.getInnerHTML(_1);if(this.$t7){var _3=this.$t7.join(isc.emptyString);_2=(_2==null||_2==isc.nbsp?_3:_2+_3)}
return _2}
...
,isc.A.getTagStart=function isc_Canvas_getTagStart(_1){var _2=isc.Canvas,_3=this.$wi();if(this.getScrollingMechanism()==isc.Canvas.CLIP&&!this.$mi&&(this.overflow==_2.HIDDEN||(this.showCustomScrollbars&&(this.overflow==_2.SCROLL||this.overflow==_2.AUTO)))){var _4=this.scrollLeft||0,_5=this.scrollTop||0;if(this.$vh==null){this.$vh=[_4,this.getWidth()+_4,this.getHeight()+_5,_5]}
_3+=";CLIP:rect("+this.$vh[0]+"px,"+this.$vh[1]+"px,"+this.$vh[2]+"px,"+this.$vh[3]+"px)"}
if(this.zIndex==_2.AUTO)this.zIndex=_2.getNextZIndex();var _6=(this.eventProxy?this.eventProxy.ID:this.ID);var _7=this.$wj(),_8=_7[0],_9=_7[1];if(!_2.$wk){_2.$wk=" onfocus=";_2.$wl=" onblur=";_2.$wm=" tabindex="
_2.$wn=" accessKey="}
...
if(this.useClipDiv){var _12=this.getCurrentCursor(),_13,_14,_15=this._useNativeTabIndex;if(this.clipHandleIsFocusHandle==false)_15=false;if(_15&&this.$mb()){_13=isc.SB.concat(_2.$wk,this.$uz(),_2.$wl,this.$u0(),!this.isDisabled()?_2.$wm+this.getTabIndex():null,(!this.$uj()&&this.accessKey!=null)?_2.$wn+this.accessKey:null);if(isc.Browser.isMoz){_14=isc.StringBuffer.concat((this.mozOutlineOffset!=null?";-moz-outline-offset:"+this.mozOutlineOffset:null),(this.mozOutlineColor!=null?";-moz-outline-color:"+this.mozOutlineColor:null),(!this.showFocusOutline?";-moz-outline-style:none":null))}else if(isc.Browser.isSafari){if(!this.showFocusOutline){_14=";outline-style:none"}}}
var _16=isc.Browser.isMoz&&isc.Browser.geckoVersion>=20080529;var _17=isc.StringBuffer.concat("<div id='",this.$wh(),"' eventProxy=",_6,(_16&&this.ariaRole?" role='"+this.ariaRole+"'":""),(_16&&this.ariaState?this.getAriaStateAttributes():""),(this.className?" class='"+this.className+"'":""),_13," style='","POSITION:",this.position,";LEFT:",this.left,"px;TOP:",this.top,"px;WIDTH:",_8,"px;HEIGHT:",_9,"px;Z-INDEX:",this.zIndex,(this.visibility==_2.INHERIT?"":";VISIBILITY:"+this.visibility),(this.backgroundColor==null?"":";BACKGROUND-COLOR:"+this.backgroundColor),(this.backgroundImage==null?"":";BACKGROUND-IMAGE:url("+this.getImgURL(this.backgroundImage)+")"+";BACKGROUND-REPEAT:"+this.backgroundRepeat+(this.backgroundPosition?";BACKGROUND-POSITION:"+this.backgroundPosition:"")),(this.border?";BORDER:"+this.border:""),(this.padding!=null||this.$wo?";PADDING:0px":""),this.$wp(),(_11!=null?(this.$rt?";-moz-opacity:":";opacity:")+_11:""),(_10?";-moz-box-sizing:border-box":null),_14,this.getTransformCSS(),(isc.Browser.isTouch?(!this.canSelectText?";-webkit-user-select:none":";-webkit-user-select:text"):null),";OVERFLOW:",_3,";' ONSCROLL='return "+_6+".$nd()'>","<div id='",this.getCanvasName(),"' eventProxy='",_6,(this.textDirection!=null?"' dir='"+this.textDirection:""),"' style='POSITION:relative;VISIBILITY:inherit",";Z-INDEX:",this.zIndex,(_12==_2.AUTO?"":";CURSOR:"+_12),(this.padding!=null?";PADDING:"+this.padding+"px":""),(this.topPadding!=null?";padding-top:"+this.topPadding+"px":""),(this.bottomPadding!=null?";padding-bottom:"+this.bottomPadding+"px":""),(this.leftPadding!=null?";padding-left:"+this.leftPadding+"px":""),(this.rightPadding!=null?";padding-right:"+this.rightPadding+"px":""),";'>")}else{if(!_2.$wq){_2.$wr=" style='POSITION:absolute;LEFT:";_2.$ws=" style='POSITION:relative;LEFT:";_2.$bh=" class='";_2.$wt="'";_2.$wu=";VISIBILITY:";_2.$wv=";CURSOR:";var _18=_2.$wq=[];_18[0]="<div id=";_18[2]=" eventProxy=";_18[15]="px;TOP:";_18[22]="px;WIDTH:";_18[28]="px;HEIGHT:";_18[34]="px;Z-INDEX:";_18[44]=";OVERFLOW:";_18[59]="' ONSCROLL='return ";_18[61]=".$nd()' "}
var _18=_2.$wq;_18[1]=this.getCanvasName();_18[3]=_6;if(this.className!=null){_18[4]=_2.$bh;_18[5]=this.className;_18[6]=_2.$wt}else{_18[4]=_18[5]=_18[6]=null}
_18[7]=(this.textDirection!=null?" dir="+this.textDirection:null);_18[8]=(this.position==_2.RELATIVE?_2.$ws:_2.$wr);isc.$bp(_18,this.left,9,6);isc.$bp(_18,this.top,16,6);isc.$bp(_18,_8,23,5);isc.$bp(_18,_9,29,5);if(this.zIndex!=_2.AUTO)isc.$bp(_18,this.zIndex,35,9);else{_18[35]=this.zIndex;_18[36]=_18[37]=_18[38]=_18[39]=_18[40]=_18[41]=_18[42]=_18[43]=null}
_18[45]=_3;if(this.visibility!=_2.INHERIT){_18[46]=_2.$wu;_18[47]=this.visibility}else{_18[46]=_18[47]=null}
_18[48]=(this.backgroundColor==null?null:";BACKGROUND-COLOR:"+this.backgroundColor);_18[49]=(this.backgroundImage==null?null:";BACKGROUND-IMAGE:url("+this.getImgURL(this.backgroundImage)+");BACKGROUND-REPEAT:"+this.backgroundRepeat+(this.backgroundPosition?";BACKGROUND-POSITION:"+this.backgroundPosition:""));_18[50]=(_10?";-moz-box-sizing:border-box":null);var _12=this.getCurrentCursor();if(_12==_2.AUTO){_18[51]=_18[52]=null}else{_18[51]=_2.$wv;_18[52]=_12}
_18[53]=this.$wp();_18[54]=(this.padding!=null?";PADDING:"+this.padding+isc.px:null);if(this.topPadding!=null)
...
if(!isc.Canvas.neverUseFilters){if(this.$ww){_18[57]=";filter:progid:DXImageTransform.Microsoft.iris(irisStyle=circle)"}else{_18[57]=null}}else{_18[57]=null}}else{if(_11!=null){_18[56]=(this.$rt?";-moz-opacity:":";opacity:")+_11}else{_18[56]=null}}
_18[58]=this.getTransformCSS();_18[60]=_6;var _19=64;if(this.$mb()&&this._useNativeTabIndex&&this.clipHandleIsFocusHandle){_18[64]=_2.$wk;_18[65]=this.$uz();_18[66]=_2.$wl;_18[67]=this.$u0();if(!this.isDisabled()){_18[68]=_2.$wm;isc.$bp(_18,this.getTabIndex(),69,5);if(this.accessKey!=null){_18[74]=_2.$wn;_18[75]=this.accessKey;_19=76}else _19=74;if(!this.showFocusOutline){if(!_2.$wx)_2.$wx=" hideFocus=true";_18[_19]=_2.$wx;_19+=1}}else _19=68}
...
_18.length=_19;_18[_19]=this.$r8;if(_1)return _18;return _18.join(isc.emptyString)}
return _17}
...
,isc.A.getOffsetTop=function isc_Canvas_getOffsetTop(){var _1=this.getClipHandle();if(isc.Browser.isMoz&&this.$xf())_1=null;if(_1==null)return this.top;var _2=isc.Element.getOffsetTop(_1);if(this.getScrollingMechanism()==isc.Canvas.CLIP){return _2+this.scrollTop}else{return _2}}
...
return-_1}
);isc.evalBoundary;isc.B.push(isc.A.$xh=function isc_Canvas__offscreenChildrenWidth(){if(!isc.isAn.Array(this.children))return 0;if(!this.useClipDiv)return 0;var _1=0;for(var i=0;i<this.children.length;i++){var _3=this.children[i],_4=(_3.position==isc.Canvas.ABSOLUTE?_3.getLeft():_3.getOffsetLeft());if(_4<_1)_1=_4}
return-_1}
...
this.$vh=_1;else
this.$vh=[_1,_2,_3,_4];var _5=this.getClipHandle();if(_5!=null){var _6=this.$vh;if(this.getScrollingMechanism()==isc.Canvas.CLIP){_6=_6.duplicate();_6[3]+=this.scrollLeft;_6[0]+=this.scrollTop;_6[1]+=this.scrollLeft;_6[2]+=this.scrollTop}
if(this.overflow==isc.Canvas.HIDDEN||(this.showCustomScrollbars==true&&(this.overflow==isc.Canvas.AUTO||this.overflow==isc.Canvas.SCROLL))){var _7=parseInt(_5.style.width),_8=_6[1],_9=parseInt(_5.style.height),_10=_6[2],_11=this.$w2(_8,_10);_8=_11[0];_10=_11[1];if(_7<_8){this.logDebug("setClip(): setting width because handle.width is smaller")
...
this.$ya()}
return true}
,isc.A.$ya=function isc_Canvas__completeResizeBy(){var _1=(this.$x8||0),_2=(this.$x9||0),_3=this.$yk,_4;this.$x8=_4;this.$x9=_4;this.$yk=_4;if(!_1&&!_2)return;var _5;if(this.isDrawn()){_5=this.shouldRedrawOnResize(_1,_2,_3);if(_5){this.markForRedraw(this.$ox)}}
...
var _3=this.getStyleHandle();_3.overflow=this.$wi();var _4=this.$wj();_3.width=_4[0];_3.height=_4[1];if(this.getScrollingMechanism()==isc.Canvas.CLIP&&!this.$mi&&(_1==isc.Canvas.HIDDEN||(this.showCustomScrollbars&&(_1==isc.Canvas.SCROLL||_1==isc.Canvas.AUTO)))){var _5=this.scrollLeft||0,_6=this.scrollTop||0;if(this.$vh==null){this.$vh=[_5,this.getWidth()+_5,this.getHeight()+_6,_6]}
_3.clip="rect("+this.$vh[0]+"px,"+this.$vh[1]+"px,"+this.$vh[2]+"px,"+this.$vh[3]+"px)"}else
if(_3.clip!=null&&_3.clip!=""&&_3.clip!="rect(auto auto auto auto)")
{_3.clip=(isc.Browser.isIE?"rect(auto)":"")}
this.adjustOverflow("setOverflow");if(_2==isc.Canvas.VISIBLE&&_1!=isc.Canvas.VISIBLE){var _7=Math.max(this.getScrollWidth()-this.getInnerWidth(),0),_8=Math.max(this.getScrollHeight()-this.getInnerHeight(),0);if(_7>0||_8>0)this.$ym(-_7,-_8,"overflow changed")}else if(_2!=isc.Canvas.VISIBLE&&_1==isc.Canvas.VISIBLE){var _7=Math.max(this.getScrollWidth()-this.getInnerWidth(),0),_8=Math.max(this.getScrollHeight()-this.getInnerHeight(),0);if(_7>0||_8>0)this.$ym(_7,_8,"overflow changed")}
...
this.$vg(this.left,this.top,_6,_5);this.setClip(0,_6,_5,0)}}
...
return _3}
,isc.A.$vg=function isc_Canvas__setHandleRect(_1,_2,_3,_4){if(this.getScrollingMechanism()==isc.Canvas.CLIP){if(_1!=null)_1-=this.scrollLeft;if(_2!=null)_2-=this.scrollTop;if(_3!=null)_3+=this.scrollLeft;if(_4!=null)_4+=this.scrollTop}
...
);isc.evalBoundary;isc.B.push(isc.A.$ms=function isc_Canvas__updateCursor(){var _1=this.getCurrentCursor();if(this.$1b==_1)return;this.$1a(_1)}
...
isc.A=isc.Canvas.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.drawRect=function isc_Canvas_drawRect(_1,_2,_3,_4,_5,_6,_7,_8){if(!this.$t7)this.$t7=[];this.$t7.add(isc.DrawRegion.getRectHTML(this,_1,_2,_3,_4,_6,_7,_8,_5))}
,isc.A.$70t=function isc_Canvas__clearRectInfo(){delete this.$70u;delete this.$t7}
);isc.B._maxIndex=isc.C+2;isc.A=isc.Canvas;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.getRectHTML=function isc_c_Canvas_getRectHTML(_1,_2,_3,_4,_5,_6,_7,_8,_9){if(_2==null)_2=0;if(_3==null)_3=0;if(_4==null)_4=1;if(_5==null)_5=1;if(!_6||_6==isc.emptyString)_6=isc.nbsp;if(!this.$70v){this.$70v=["<DIV class='",,"' style='",,";position:absolute;overflow:hidden;left:",,,,,,,"px;top:",,,,,,,"px;width:",,,,,,"px;height:",,,,,,"px;' ID='",,"_rect_",,,,,,"' eventpart='rect'>",,"</DIV>"]}
if(!_1.$70u)_1.$70u=0;var _10=this.$70v;_10[1]=_7;_10[3]=_8;isc.$bp(_10,_2,5,6);isc.$bp(_10,_3,12,6);isc.$bp(_10,_4,19,5);isc.$bp(_10,_5,25,5);_10[31]=_1.getID();if(!_9)_9=_1.$70u++;if(isc.isA.Number(_9)&&_9<100000)
isc.$bp(_10,_9,33,5);else
