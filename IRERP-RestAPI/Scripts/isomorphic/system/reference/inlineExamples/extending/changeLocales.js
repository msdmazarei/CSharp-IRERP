...
isc.ListGrid.create({
    ...
    fields:[
        ...
        {name:"population", formatCellValue:"isc.Format.toUSString(value)", title: myApp.messages.populationTitle},
        {name:"area", formatCellValue:"isc.Format.toUSString(value)", title: myApp.messages.area},
