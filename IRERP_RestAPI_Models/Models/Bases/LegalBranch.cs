...
{
    public class LegalBranch : IRERP_RestAPI.Bases.ModelBaseLog<LegalBranch, LegalBranchLog>
    {
        public LegalBranch() { }
        //Fields list
        ...
        public override MsdLib.CSharp.DALCore.INHibernateEntity LoadByPrimaryKeys(Dictionary<string, object> primarykeys_value)
        {
                        ...
                        && primarykeys_value[_GPN(x => x.id)] != null)
            {
                ...
                return ModelRepositories.Bases.LegalBranch_Repository.GetLegalBranchByID(this.id);
            }
            else
                return null;
            //save 
        ...
        public override LegalBranchLog CreateLog(ModelBaseLog<LegalBranch, LegalBranchLog> input)
        {
            LegalBranch ths = (LegalBranch)input;

            LegalBranchLog l = new LegalBranchLog();
            l.id = ths.id;
            l.Name = ths.Name;
        ...
        public virtual IList<LegalCharacter> LegalCharacters
        {
            get
            {
                return
                    ...
                    ModelRepositories.Bases.LegalCharacter_Repository.GetlegalCharachterByBranchId<LegalBranch>,
                    x => x.id,
            ...
            get
            {
                if (_GPN(x => x.Name) == columnName)
                {
                    ...
                    if (Name.NotEmpty())
                    {
                        ...
                        {
                            this.Name = Name.Trim();
                            if (!ModelRepositories.Bases.LegalBranch_Repository.GetLegalBranchByName(this))
