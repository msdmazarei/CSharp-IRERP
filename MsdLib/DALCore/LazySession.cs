...
namespace MsdLib.CSharp.DALCore
{
    ...
    public class LazySessionContext : ICurrentSessionContext
    {
        ...
        public LazySessionContext(ISessionFactory factory)
        {
    ...
    public class NHibernateSessionModule : IHttpModule
    {
        ...
        {
            get { return "NHibernateSessionModule"; }
        }
        public void Init(HttpApplication context) 
        {
            app = context;
            sfp = (ISessionFactoryProvider)context.Application[SessionFactoryProvider.Key];
